      ...
      return <article key={model.id} className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="grid items-start sm:grid-cols-[150px_minmax(0,1fr)]">
          ...
          <div className="min-w-0 p-4">
            ...
            <h3 className="mt-1 break-words text-base font-black leading-6">{model.title_zh}</h3><div className="mt-1 truncate font-mono text-[11px] text-slate-400">#{model.sort_order} · {model.slug}</div>
